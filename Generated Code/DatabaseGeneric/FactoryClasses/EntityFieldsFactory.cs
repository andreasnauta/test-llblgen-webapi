...
namespace EntityModel.FactoryClasses
{
	...
	{
		private static readonly Dictionary<EntityModel.EntityType, string> _entityTypeNamesCache = new Dictionary<EntityModel.EntityType, string>();

		/// <summary>static ctor which initializes the static entity type cache.</summary>
		static EntityFieldsFactory()
		{
			foreach(EntityModel.EntityType value in Enum.GetValues(typeof(EntityModel.EntityType)))
			{
				_entityTypeNamesCache.Add(value, Enum.GetName(typeof(EntityModel.EntityType), value));
			}
		}	
