...
namespace EntityModel.FactoryClasses
{
	...
	{
		private readonly EntityModel.EntityType _typeOfEntity;
		...
		{
			return GeneralEntityFactory.Create((EntityModel.EntityType)entityTypeValue);
		}
	...
	public partial class CollectionEntityFactory : EntityFactoryBase2<CollectionEntity> {
		/// <summary>CTor</summary>
		public CollectionEntityFactory() : base("CollectionEntity", EntityModel.EntityType.CollectionEntity, false) { }
		
		/// <summary>Creates a new CollectionEntity instance but uses a special constructor which will set the Fields object of the new IEntity2 instance to the passed in fields object.</summary>
		/// <param name="fields">Populated IEntityFields2 object for the new IEntity2 to create</param>
		/// <returns>Fully created and populated (due to the IEntityFields2 object) IEntity2 object</returns>
		public override IEntity2 Create(IEntityFields2 fields) {
	...
	public partial class ItemEntityFactory : EntityFactoryBase2<ItemEntity> {
		/// <summary>CTor</summary>
		public ItemEntityFactory() : base("ItemEntity", EntityModel.EntityType.ItemEntity, true) { }
	...
	/// <summary>Factory to create new, empty DomainItemEntity objects.</summary>
	[Serializable]
	public partial class DomainItemEntityFactory : EntityFactoryBase2<DomainItemEntity> {
		/// <summary>CTor</summary>
		public DomainItemEntityFactory() : base("DomainItemEntity", EntityModel.EntityType.DomainItemEntity, true) { }
		
		/// <summary>Creates a new DomainItemEntity instance but uses a special constructor which will set the Fields object of the new IEntity2 instance to the passed in fields object.</summary>
		/// <param name="fields">Populated IEntityFields2 object for the new IEntity2 to create</param>
		/// <returns>Fully created and populated (due to the IEntityFields2 object) IEntity2 object</returns>
		public override IEntity2 Create(IEntityFields2 fields) {
	...
	/// <summary>Factory to create new, empty SpecificItemEntity objects.</summary>
	[Serializable]
	public partial class SpecificItemEntityFactory : EntityFactoryBase2<SpecificItemEntity> {
		/// <summary>CTor</summary>
		public SpecificItemEntityFactory() : base("SpecificItemEntity", EntityModel.EntityType.SpecificItemEntity, true) { }
		
		/// <summary>Creates a new SpecificItemEntity instance but uses a special constructor which will set the Fields object of the new IEntity2 instance to the passed in fields object.</summary>
		/// <param name="fields">Populated IEntityFields2 object for the new IEntity2 to create</param>
		/// <returns>Fully created and populated (due to the IEntityFields2 object) IEntity2 object</returns>
		public override IEntity2 Create(IEntityFields2 fields) {
	...
	public static class EntityFactoryFactory
	{
		...
		{
			Array entityTypeValues = Enum.GetValues(typeof(EntityModel.EntityType));
			foreach(int entityTypeValue in entityTypeValues)
			{
				IEntity2 dummy = GeneralEntityFactory.Create((EntityModel.EntityType)entityTypeValue);
	...
	{
		/// <summary>Gets the factory of the Entity type with the EntityModel.EntityType value passed in</summary>
		...
		{
			return new DynamicRelation(leftOperand, joinType, (EntityModel.EntityType)Enum.Parse(typeof(EntityModel.EntityType), rightOperandEntityName, false), aliasRightOperand, onClause);
		}
		...
		{
			return new DynamicRelation((EntityModel.EntityType)Enum.Parse(typeof(EntityModel.EntityType), leftOperandEntityName, false), joinType, (EntityModel.EntityType)Enum.Parse(typeof(EntityModel.EntityType), rightOperandEntityName, false), aliasLeftOperand, aliasRightOperand, onClause);
		}
		...
		{
			return new DynamicRelation(leftOperand, joinType, (EntityModel.EntityType)Enum.Parse(typeof(EntityModel.EntityType), rightOperandEntityName, false), aliasLeftOperand, aliasRightOperand, onClause);
		}
		
		/// <summary>Implementation of the routine which gets the factory of the Entity type with the EntityModel.EntityType value passed in</summary>
		/// <param name="entityTypeValue">The entity type value.</param>
		/// <returns>the entity factory of the entity type or null if not found</returns>
		protected override IEntityFactoryCore GetFactoryImpl(int entityTypeValue)
		{
			return EntityFactoryFactory.GetFactory((EntityModel.EntityType)entityTypeValue);
		}
