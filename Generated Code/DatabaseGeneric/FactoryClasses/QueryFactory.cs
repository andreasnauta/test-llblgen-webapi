...
namespace EntityModel.FactoryClasses
{
	...
	public partial class QueryFactory
	{
		...
		/// <summary>Creates and returns a new EntityQuery for the DomainItem entity</summary>
		public EntityQuery<DomainItemEntity> DomainItem
		{
			get { return Create<DomainItemEntity>(); }
		}

		/// <summary>Creates and returns a new EntityQuery for the SpecificItem entity</summary>
		public EntityQuery<SpecificItemEntity> SpecificItem
		{
			get { return Create<SpecificItemEntity>(); }
		}
